...
import 'package:trashapp_new/datas/icon.dart';
...
class Gopay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Container(
          height: 96,
          decoration: BoxDecoration(color: blue1, borderRadius: BorderRadius.circular(15)),
          child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          color: const Color(0xFFBBBBBB), borderRadius: BorderRadius.circular(1)),
                    ),
                    const SizedBox(
                      height: 4,
                    ),
